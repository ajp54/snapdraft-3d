...
const DEFAULT_PRESETS: PartDefinition[] = [
  // Lumber
  {
    ...
    name: '2x4x8 Stud',
    category: 'Lumber',
    dimensions: { width: 1.5, height: 3.5, depth: 96 },
    color: '#D2B48C',
    unitPrice: 5.99,
    isCustom: false,
  },
  {
    ...
    name: '4x4x8 Post',
    category: 'Lumber',
    dimensions: { width: 3.5, height: 3.5, depth: 96 },
    color: '#8B6F47',
    unitPrice: 12.99,
    isCustom: false,
  },
  {
    ...
    name: '2x6x12 Joist',
    category: 'Lumber',
    dimensions: { width: 1.5, height: 5.5, depth: 144 },
    color: '#D2B48C',
    unitPrice: 8.99,
    isCustom: false,
  },
  {
    ...
    name: '2x8x12 Beam',
    category: 'Lumber',
    dimensions: { width: 1.5, height: 7.5, depth: 144 },
    color: '#D2B48C',
    unitPrice: 11.99,
    isCustom: false,
  },
